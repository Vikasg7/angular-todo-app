...
AppModule = __decorate([
    core_1.NgModule({
        ...
        providers: [todo_1.TodoSrv, storage_1.StorageSrv],
...
const core_1 = require("@angular/core");
const todo_1 = require("../services/todo");
let TodoText = class TodoText {
    constructor(todoSrv) {
        this.todoSrv = todoSrv;
    }
    async updateTodo(editedText) {
...
], TodoText.prototype, "todo", void 0);
TodoText = __decorate([
    core_1.Component({
        selector: "todo-text",
        template: `
   ...
   `
    ...
    __metadata("design:paramtypes", [todo_1.TodoSrv])
], TodoText);
...
let HeaderComponent = class HeaderComponent {
    ...
    add() {
        const todo = { id: Date.now(), todo: this.todo, isDone: 0 };
...
let TodoSrv = class TodoSrv {
    constructor(_storage) {
        this._storage = _storage;
        this._todoList = new BehaviorSubject_1.BehaviorSubject(immutable_1.List([]));
    ...
    async del(todo) {
        await this._storage.del(todo.id);
        const l = this._todoList.getValue();
...
TodoSrv = __decorate([
    core_1.Injectable(),
    __metadata("design:paramtypes", [storage_1.StorageSrv])
], TodoSrv);
...
const core_1 = require("@angular/core");
const immutable_1 = require("immutable");
let StorageSrv = class StorageSrv {
    constructor() { }
    _executeSql(query, values = []) {
    ...
    async getAllTodos() {
        ...
        for (let i = 0; i < rLen; i++) {
            rows.unshift(results.rows.item(i));
        }
        return immutable_1.List(rows);
    }
};
